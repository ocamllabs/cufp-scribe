...
Their Haskell IDE was built almost entirely in Haskell, using
libraries and frameworks, mostly as-is, available on Hackage. They
used Yesod\needcite as a web framework.

The IDE comprises

\begin{itemize}

\item A web frontend. No setup is required, and it is integrated with
the Haskell compiler.

\item A Haskell backend implementing project management, 
developer feedback (error reporting), a build system, and an
execution and deployment platform.
