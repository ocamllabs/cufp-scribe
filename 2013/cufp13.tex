...
etc? Mike says Yes.  Or on the quality of submissions?  Mike says No.}
...
and the JVM Java Virtual Machine \note{The JVM? Really?  Mike is also
  hazy on what role he played exactly in Eclipse}, talked to us about his experiences
...
and techniques are a good fit; then expand from there.  Mike says we
should put it in the introduction.}
